...
const createGreetingMessage = roomRecord => {
  ...
  return `안녕하세요, ${userName}님! 모브 ${coachName}입니다. ${userName}님의 건강한 체중 감량을 위해 오늘부터 2주 동안(~2/11) 채팅을 통해 꼼꼼한 식단 관리를 해드릴 예정입니다. 

모브 앱에 매일 체중과 식단을 기록해 주시면 문진표에 작성해 주신 전반적인 건강 상태를 바탕으로 ${userName}님의 식습관과 생활습관, 그리고 월경주기를 분석해 건강한 다이어트 솔루션을 제공해 드리겠습니다!

앞으로의 관리에 있어서 가장 중요한 6가지 규칙에 대해 알려드리겠습니다.

1️⃣ 식단일기 매일 보내기
식사를 하시기 전에 어떤 것을 먹어야 할지, 어떤 것을 먹을 계획인지 말씀해 주시면 균형 잡힌 식사를 하실 수 있도록 팁을 드릴 예정입니다. 식사를 하실 때는 식사 메뉴를 사진을 찍어 보내주세요. 사진을 통해서 더욱 상세한 피드백을 드릴 수 있고 ${userName}님의 식단 변화를 볼 수 있어요. 하단의 + 버튼을 누르시면 사진을 전송할 수 있습니다.

술 약속이나 외식이 있을 경우에는 사전에 말씀해 주시면 상황에 맞는 팁을 드릴게요. 주말이나 이른 아침, 늦은 저녁 식사의 경우 코치의 활동 시간인 평일 오전 10시~오후6시 사이에 미리 상담을 해주세요.
...
3️⃣ 3끼 식사는 ‘밥’으로 먹기
과일, 빵, 시리얼, 음료 등의 대체식으로 식사를 하거나 식사를 거르는 등 규칙적인 3끼 식사가 진행이 되지 않을 경우에는 효과적인 다이어트를 기대하기 어렵고, 요요가 올 확률도 높아집니다. 3대 영양소를 골고루 먹거나 최대한 ‘밥’위주의 식사를 진행해 주세요!

4️⃣ 아침 체중&저녁 체중 기록하기
매일 아침 체중과 저녁 체중을 측정해 주세요.
...
6️⃣ 물을 마시는 습관 바꾸기
수분 섭취는 마시는 양 보다 마시는 방법이 더욱 중요합니다. 벌컥벌컥 급하게 물을 마시는 습관, 차가운 물을 마시는 습관은 체온을 떨어뜨리면서 신진대사를 저하시킵니다. 따뜻하게 마시는 수분 섭취는 체온을 서서히 높여주기 때문에 몸의 면역력 뿐만 아니라 신진대사를 원활하게 도와주기 때문에 따뜻한 물 마시기 습관만으로도 요요 없는 몸을 만들 수 있습니다.

따뜻한 물 마시기를 싫어하는 경우에는 평소에 짜게 먹는 습관이 익숙한 사람일 확률이 높습니다. 평소에 내가 짜게 먹고 있지는 않은지, 염분 조절은 잘 되고 있는지 확인해 주세요.

다이어트에서 가장 중요한 것은 적게 먹고 운동하는 것이 아닌, 내 몸 스스로 소비할 수 있는 몸을 만드는 것 입니다. 몸에 불필요한 노폐물을 배출시키고, 신진대사를 끌어올려서 체지방을 감량할 수 있는 건강한 식습관 플랜을 모브와 함께 시작해요.

본격적인 코칭을 시작하기 전에 ${userName}님이 주로 어떤 방식으로 다이어트를 하는지에 대해 알려주세요!`;
};
