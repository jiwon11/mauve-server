...
1️⃣ 식단일기 매일 보내기
식사를 하시기 전에 어떤 것을 먹어야 할지, 어떤 것을 먹을 계획인지 말씀해 주시면 균형 잡힌 식사를 하실 수 있도록 팁을 드릴 예정입니다. 식사를 하실 때는 식사 메뉴를 사진을 찍어 보내주세요. 사진을 통해서 더욱 상세한 피드백을 드릴 수 있고 ${userName}님의 식단 변화를 볼 수 있어요. 
하단의 + 버튼을 누르시면 사진을 전송할 수 있습니다.
